...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SEMTECH_SX1262_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_SX126X, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STOP_START_STREAMS_SW1, 1);
